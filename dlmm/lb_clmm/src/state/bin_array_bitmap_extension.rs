...
impl BinArrayBitmapExtension {
    pub fn try_deserialize(data: &[u8]) -> Result<Self, Box<dyn std::error::Error>> {
        Ok(BinArrayBitmapExtension::try_from_slice(data)?)
    }
    ...
    //N
    fn get_bitmap_offset(bin_array_index: i32) -> Result<usize, LBError> {
    ...
    fn get_bitmap(&self, bin_array_index: i32) -> Result<(usize, [u64; 8]), LBError> {
    ...
    //n
    fn bin_array_offset_in_bitmap(bin_array_index: i32) -> Result<usize, LBError> {
        if bin_array_index > 0 {
    ...
    ///
    /*
    pub fn flip_bin_array_bit(&mut self, bin_array_index: i32) -> Result<(), LBError> {
    ...
    */
    ...
    pub fn bit(&self, bin_array_index: i32) -> Result<bool, LBError> {
    ...
    //n
    pub fn iter_bitmap(&self, start_index: i32, end_index: i32) -> Result<Option<i32>, LBError> {
