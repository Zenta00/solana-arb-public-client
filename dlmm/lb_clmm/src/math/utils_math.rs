...
#[inline]
pub fn safe_pow_cast<T: FromPrimitive>(base: u128, exp: i32) -> Result<T, LBError> {
...
#[inline]
pub fn safe_mul_div_cast_from_u64_to_u64(x: u64, y: u64, denominator: u64) -> Result<u64, LBError> {
    let x = u128::from(x);
    let y = u128::from(y);
...
#[inline]
pub fn safe_mul_div_cast_from_u256_to_u64(
    x: u64,
    y: U256,
    denominator: U256,
) -> Result<u64, LBError> {
